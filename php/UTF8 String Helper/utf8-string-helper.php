 ...
 * @return string
 */
function utf8_strlen(string $string): string
{
 ...
 * @return string
 */
function utf8_strpos(string $string, string $needle, int $offset = 0): string
{
 ...
 * @return string
 */
function utf8_strrpos(string $string, string $needle): string
{
 ...
 * @return string
 */
function utf8_to_unicode(string $string): string
{
    $unicode = array();
 ...
 * @return string
 */
function unicode_to_utf8(string $unicode): string
{
    $string = '';
